...
class Dataloader():
    ...
    def __next__(self):
        ...
        indexs = indexs[self.cursor:self.cursor+self.dataset.batch_size]
        print(indexs)
...
if __name__ == "__main__":
    ...
    # test_data = (load_images("dataset/t10k-images.idx3-ubyte") - np.mean(train_data)) / np.std(train_data)
    ...
    for e in range(epoch):
        ...
        if True:
            ...
            print(f"epoch:{e} loss:{loss:.3f}||||acc:{acc:.5f}|||lr:{lr:.3f}")
